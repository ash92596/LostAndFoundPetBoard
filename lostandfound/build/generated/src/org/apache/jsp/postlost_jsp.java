...
public final class postlost_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            </select>\n");
      out.write("            <input type=\"hidden\" name=\"latposition\" id=\"latposition\"/> <!-- hidden types are used javascript function then given a value -->\n");
      out.write("            <input type=\"hidden\" name=\"lngposition\" id=\"lngposition\"/>\n");
      out.write("            <input type=\"hidden\" name=\"area\" id=\"area\"/>\n");
      ...
      out.write("    <script>\n");
      out.write("        \n");
      out.write("        // initializes map and stores coordinates from user placed marker\n");
      out.write("      var map;\n");
      ...
      out.write("           var lg = new google.maps.LatLng(locationlat, locationlng);\n");
      out.write("           GeoCode(lg);\n");
      out.write("      }\n");
      out.write("      \n");
      out.write("      function GeoCode(geo){ \n");
      out.write("       geocoder.geocode({'latLng': geo}, function(results, status) {\n");
      out.write("                    \n");
      out.write("                    if (status === 'OK') {\n");
      out.write("                       if (results[2]) { \n");
      out.write("                       \n");
      out.write("                     var area=(results[2].formatted_address);\n");
      out.write("                      document.getElementById('area').value=area;\n");
      out.write("                      \n");
      out.write("                       \n");
      out.write("                       }\n");
      out.write("                    }\n");
      ...
      out.write("          \n");
      out.write("          //put coordinates into hidden values and submitted to servlet\n");

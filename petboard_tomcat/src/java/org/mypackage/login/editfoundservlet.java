 ...
 * @author Connor
 */
@WebServlet(name = "editfoundservlet", urlPatterns = {"/editfoundservlet"})
public class editfoundservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet editfoundservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet editfoundservlet at " + message + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }

<%-- 
    Document   : editfound
    Created on : Feb 14, 2019, 12:44:22 PM
    Author     : Connor
--%>
...
<html>
    ...
    <body>
        ...
        String url = String.format("jdbc:sqlserver://%s:1433;databaseName=%s;user=%s;password=%s;encrypt=true;"
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from foundpets where userid='"+currentUser.getUsername()+"'") ; 
        ...
        <form id="edit" name="update" action="editfoundservlet" method="POST">
                User:
                ...
                <select name="status" >
                        <option>Searching for owner</option>
                        <option>Surrendered to shelter</option>
                    </select>
